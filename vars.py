...
# API Configuration
API_ID = int(os.environ.get("API_ID", "32887550"))
API_HASH = os.environ.get("API_HASH", "8385993e9b9dffc69ca579c5a3b2076b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8299474852:AAEzixpRUf8aEZPtBV-6TW2qz5i6cb2biOY")

CREDIT = os.environ.get("CREDIT", "Bhumihar")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "7652075308"))
ADMINS = [7652075308,7652075308]  # dono admins id list me
